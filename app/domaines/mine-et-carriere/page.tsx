  ...
  const fetchProducts = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from('products')
        .select('*')
        .contains('secteurs_activite', ['Mine et carriere']);
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900">
              Solutions Robustes pour l'Industrie Minière
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              Dans le secteur minier et des carrières, la fiabilité et la durabilité sont essentielles. 
              Nos pompes sont conçues pour résister aux conditions les plus exigeantes et assurer un 
              fonctionnement continu dans des environnements difficiles. Nous proposons des solutions 
              adaptées pour le transfert de boues, le drainage et le traitement des eaux.
            </p>
          </div>
        </div>
      </section>
